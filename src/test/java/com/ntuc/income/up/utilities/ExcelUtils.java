...
import static com.ntuc.income.up.utilities.CommonUtils.LOGGER;
import static com.ntuc.income.up.utilities.FileUtils.deleteFile;
import static com.ntuc.income.up.utilities.FileUtils.getAllFiles;
...
public class ExcelUtils {
    ...
    private Workbook getExcelFile() {
        ...
        try {
            for (File temp : getAllFiles(parentDir)) {
            ...
            for (int dataRow = startRow; dataRow < worksheet.getLastRowNum() + 1; dataRow++) {
                ...
                if (data.contentEquals(scenarioName)) {
                    for (int col = 1; col < worksheet.getRow(dataRow).getLastCellNum(); col++) {
                        ...
                        CellType lblScenarioCellTyp = lblScenarioCell.getCellTypeEnum();
                        CellType valScenarioCellTyp = valScenarioCell.getCellTypeEnum();
